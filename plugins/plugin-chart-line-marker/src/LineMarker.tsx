...
import { LineMarkerProps, LineMarkerStylesProps } from './types';
...
const Styles = styled.div<LineMarkerStylesProps>`
...
export default function LineMarker(props: LineMarkerProps) {
