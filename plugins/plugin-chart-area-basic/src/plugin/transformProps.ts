...
import { AreaBasicProps } from '../types';
import { sortBy } from 'lodash';

export default function transformProps(chartProps: ChartProps): AreaBasicProps {
  /**
   ...
   * can also be accessed from your AreaBasic.tsx file, but
