...
import { AreaBasicProps, AreaBasicStylesProps } from './types';
...
const Styles = styled.div<AreaBasicStylesProps>`
...
export default function AreaBasic(props: AreaBasicProps) {
