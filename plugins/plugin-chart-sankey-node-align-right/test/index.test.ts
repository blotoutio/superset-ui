 ...
 * under the License.
 */
import { SankeyNodeAlignRightChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-sankey-node-align-right', () => {
  it('exists', () => {
    expect(SankeyNodeAlignRightChartPlugin).toBeDefined();
  });
});
