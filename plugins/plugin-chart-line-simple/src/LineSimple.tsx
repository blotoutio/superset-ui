...
import { LineSimpleProps, LineSimpleStylesProps } from './types';
...
const Styles = styled.div<LineSimpleStylesProps>`
...
export default function LineSimple(props: LineSimpleProps) {
