...
import { BarBackgroundProps, BarBackgroundStylesProps } from './types';
...
const Styles = styled.div<BarBackgroundStylesProps>`
...
export default function BarBackground(props: BarBackgroundProps) {
  ...
  useEffect(() => {
    ...
    let xaxisWidth = width;
      if(echartOptions.legend.data.length > 0){
        xaxisWidth = (echartOptions.legend.data.length * (echartOptions.series[0]['data'].length*4))*10;
      }
