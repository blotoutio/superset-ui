...
import { BarBackgroundProps } from '../types';

export default function transformProps(chartProps: ChartProps): BarBackgroundProps {
  /**
   ...
   * can also be accessed from your BarBackground.tsx file, but
