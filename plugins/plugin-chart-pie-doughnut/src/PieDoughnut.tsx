...
import { PieDoughnutProps, PieDoughnutStylesProps } from './types';
...
const Styles = styled.div<PieDoughnutStylesProps>`
...
export default function PieDoughnut(props: PieDoughnutProps) {
